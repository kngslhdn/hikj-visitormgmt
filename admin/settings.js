...
async function render(tab='whatsapp',token=null){if(!current(token))return;
 style();const role=String(window.HIKJAdminRole||'').toUpperCase(),tabs=role==='SUPERADMIN'?['property','whatsapp','admins','keys','operations','audit']:['property'];
